...
/* ex3.4 Following the approach of the lissajous example in section 1.7, construct a web server that computes surfaces
and writes svg data to the client. The server must set the content-type header like this:
